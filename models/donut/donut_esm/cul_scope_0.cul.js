    ...
    import { R1_ as R1$, R2_ as R2$, A_ as A$, B_ as B$, frame_ as frame$, K2_ as K2$, K1_ as K1$, screen_width_ as screen_width$, screen_height_ as screen_height$, theta_ as theta$, phi_ as phi$, cosA_ as cosA$, sinA_ as sinA$, cosB_ as cosB$, sinB_ as sinB$, cosTheta_ as cosTheta$, sinTheta_ as sinTheta$, cosPhi_ as cosPhi$, sinPhi_ as sinPhi$, circlex_ as circlex$, circley_ as circley$, x_ as x$, y_ as y$, z_ as z$, xp_ as xp$, yp_ as yp$ } from './donut.cul.js?+memoed'; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
