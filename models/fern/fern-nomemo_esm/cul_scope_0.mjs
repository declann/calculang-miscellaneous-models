...
export const winning_transform_values = ({ i_in }) => barnsley_transforms({})[winner({ i_in })];

export const i = ({ i_in }) => i_in;

// a draw determines which transformation to apply in each iteration
export const winner = ({ i_in }) => {
...
// also abstract this..
export const barnsley_0 = ({ i_in }) => winning_transform_values({ i_in })[0];
export const barnsley_1 = ({ i_in }) => winning_transform_values({ i_in })[1];
export const barnsley_2 = ({ i_in }) => winning_transform_values({ i_in })[2];
export const barnsley_3 = ({ i_in }) => winning_transform_values({ i_in })[3];
export const barnsley_4 = ({ i_in }) => winning_transform_values({ i_in })[4];
export const barnsley_5 = ({ i_in }) => winning_transform_values({ i_in })[5];
