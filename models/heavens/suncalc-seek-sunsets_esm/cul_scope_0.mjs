...
export const duration_factor = (a) => {
  ...
  // eslint-disable-next-line no-undef
  duration_factor$({ duration_factor_in }); // never run, but here to "trick" calculang graph logic
};
