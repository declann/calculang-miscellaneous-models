import { y } from "./cul_scope_0.mjs";import { x1 } from "./cul_scope_0.mjs";import { angle } from "./cul_scope_0.mjs"; // some references:
...
// trend + arcy * wavey
export const y_ = ({ x_in, pinchiness_in, arc_size_in, waviness_in, tallness_in }) => trend({ x_in, pinchiness_in }) + arcy({ x_in, arc_size_in }) * wavey({ waviness_in, x_in }) * tallness({ tallness_in });