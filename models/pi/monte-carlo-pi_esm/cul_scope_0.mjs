...
import { p_ as p$, x_ as x$, y_ as y$, f_ as f$, inside_ as inside$, inside_count_ as inside_count$, ratio_ as ratio$, pi_approximation_ as pi_approximation$ } from "./cul_scope_1.mjs"; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
