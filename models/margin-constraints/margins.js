...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "num_bars$m", function() { return num_bars$m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "num_bars", function() { return num_bars; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "container_height$m", function() { return container_height$m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "container_height", function() { return container_height; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "top_margin$m", function() { return top_margin$m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "top_margin", function() { return top_margin; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bottom_margin$m", function() { return bottom_margin$m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bottom_margin", function() { return bottom_margin; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gap$m", function() { return gap$m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "gap", function() { return gap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bar_height$m", function() { return bar_height$m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bar_height", function() { return bar_height; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "error$m", function() { return error$m; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "error", function() { return error; });
/* harmony import */ var underscore__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29);
/* harmony import */ var _margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
...
const num_bars$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* num_bars_ */ "f"], JSON.stringify);
const num_bars = (a) => {
  return num_bars$m(a);
  // eslint-disable-next-line no-undef
  Object(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* num_bars_ */ "f"])({ num_bars_in }); // never run, but here to "trick" calculang graph logic
};
...
const container_height$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* container_height_ */ "c"], JSON.stringify);
const container_height = (a) => {
  return container_height$m(a);
  // eslint-disable-next-line no-undef
  Object(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* container_height_ */ "c"])({ container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }); // never run, but here to "trick" calculang graph logic
};
...
const top_margin$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* top_margin_ */ "g"], JSON.stringify);
const top_margin = (a) => {
  return top_margin$m(a);
  // eslint-disable-next-line no-undef
  Object(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* top_margin_ */ "g"])({ top_margin$_in, container_height$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }); // never run, but here to "trick" calculang graph logic
};
...
const bottom_margin$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* bottom_margin_ */ "b"], JSON.stringify);
const bottom_margin = (a) => {
  return bottom_margin$m(a);
  // eslint-disable-next-line no-undef
  Object(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* bottom_margin_ */ "b"])({ bottom_margin$_in, container_height$_in, top_margin$_in, num_bars_in, gap$_in, bar_height$_in }); // never run, but here to "trick" calculang graph logic
};
...
const gap$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* gap_ */ "e"], JSON.stringify);
const gap = (a) => {
  return gap$m(a);
  // eslint-disable-next-line no-undef
  Object(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* gap_ */ "e"])({ gap$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, bar_height$_in }); // never run, but here to "trick" calculang graph logic
};
...
const bar_height$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* bar_height_ */ "a"], JSON.stringify);
const bar_height = (a) => {
  return bar_height$m(a);
  // eslint-disable-next-line no-undef
  Object(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* bar_height_ */ "a"])({ bar_height$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in }); // never run, but here to "trick" calculang graph logic
};
...
const error$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* error_ */ "d"], JSON.stringify);
const error = (a) => {
  return error$m(a);
  // eslint-disable-next-line no-undef
  Object(_margins_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* error_ */ "d"])({ container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }); // never run, but here to "trick" calculang graph logic
};
...
"use strict";
/* unused harmony export top_margin$ */
/* unused harmony export bottom_margin$ */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return num_bars_; });
/* unused harmony export gap$ */
/* unused harmony export bar_height$ */
/* unused harmony export container_height$ */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return container_height_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return top_margin_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return bottom_margin_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return gap_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return bar_height_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return error_; });
/* harmony import */ var _margins_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
 // using constraint equation used by Bret Victor in:
// http://worrydream.com/ScrubbingCalculator/

const top_margin$ = ({ top_margin$_in }) => top_margin$_in;
const bottom_margin$ = ({ bottom_margin$_in }) => bottom_margin$_in;
const num_bars_ = ({ num_bars_in }) => num_bars_in; // not unlockable (fut: possibly, with a remainder?)
const gap$ = ({ gap$_in }) => gap$_in;
const bar_height$ = ({ bar_height$_in }) => bar_height$_in;
const container_height$ = ({ container_height$_in }) => container_height$_in;
...
const container_height_ = ({ container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) =>
...
: Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["top_margin"])({ top_margin$_in, container_height$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) +
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bottom_margin"])({ bottom_margin$_in, container_height$_in, top_margin$_in, num_bars_in, gap$_in, bar_height$_in }) +
(Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) - 1) * Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["gap"])({ gap$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, bar_height$_in }) +
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) * Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bar_height"])({ bar_height$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in });

// I do manual algebraic manipulation below, some tools can do this auto, investigate?

const top_margin_ = ({ top_margin$_in, container_height$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) =>
top_margin$({ top_margin$_in }) != undefined ?
top_margin$({ top_margin$_in }) :
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["container_height"])({ container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) - (
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bottom_margin"])({ bottom_margin$_in, container_height$_in, top_margin$_in, num_bars_in, gap$_in, bar_height$_in }) + (Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) - 1) * Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["gap"])({ gap$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, bar_height$_in }) + Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) * Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bar_height"])({ bar_height$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in }));

const bottom_margin_ = ({ bottom_margin$_in, container_height$_in, top_margin$_in, num_bars_in, gap$_in, bar_height$_in }) =>
bottom_margin$({ bottom_margin$_in }) != undefined ?
bottom_margin$({ bottom_margin$_in }) :
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["container_height"])({ container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) - (
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["top_margin"])({ top_margin$_in, container_height$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) + (Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) - 1) * Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["gap"])({ gap$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, bar_height$_in }) + Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) * Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bar_height"])({ bar_height$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in }));

const gap_ = ({ gap$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, bar_height$_in }) =>
...
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bottom_margin"])({ bottom_margin$_in, container_height$_in, top_margin$_in, num_bars_in, gap$_in, bar_height$_in }) -
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) * Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bar_height"])({ bar_height$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in })) / (
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) - 1);

const bar_height_ = ({ bar_height$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in }) =>
bar_height$({ bar_height$_in }) != undefined ?
bar_height$({ bar_height$_in }) :
(Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["container_height"])({ container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) -
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["top_margin"])({ top_margin$_in, container_height$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) -
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bottom_margin"])({ bottom_margin$_in, container_height$_in, top_margin$_in, num_bars_in, gap$_in, bar_height$_in }) -
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["gap"])({ gap$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, bar_height$_in }) * (Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) - 1)) /
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in });

// error function
const error_ = ({ container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) =>
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["container_height"])({ container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) - (
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["top_margin"])({ top_margin$_in, container_height$_in, bottom_margin$_in, num_bars_in, gap$_in, bar_height$_in }) +
Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["bottom_margin"])({ bottom_margin$_in, container_height$_in, top_margin$_in, num_bars_in, gap$_in, bar_height$_in }) +
(Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["num_bars"])({ num_bars_in }) - 1) * Object(_margins_cul_js__WEBPACK_IMPORTED_MODULE_0__["gap"])({ gap$_in, container_height$_in, top_margin$_in, bottom_margin$_in, num_bars_in, bar_height$_in }) +
