...
export const num_bars = (a) => {
  ...
  num_bars$(); // never run, but here to "trick" calculang graph logic
};
...
export const container_height = (a) => {
  ...
  // eslint-disable-next-line no-undef
  container_height$(); // never run, but here to "trick" calculang graph logic
};
...
export const top_margin = (a) => {
  ...
  // eslint-disable-next-line no-undef
  top_margin$(); // never run, but here to "trick" calculang graph logic
};
...
export const bottom_margin = (a) => {
  ...
  // eslint-disable-next-line no-undef
  bottom_margin$(); // never run, but here to "trick" calculang graph logic
};
...
export const gap = (a) => {
  return gap$m(a);
  // eslint-disable-next-line no-undef
  gap$(); // never run, but here to "trick" calculang graph logic
};
