...
export const usc_taxable_by_band_id = (a) => {
  ...
  // eslint-disable-next-line no-undef
  usc_taxable_by_band_id$(); // never run, but here to "trick" calculang graph logic
};
...
export const pay_period = (a) => {
  ...
  // eslint-disable-next-line no-undef
  pay_period$(); // never run, but here to "trick" calculang graph logic
};
...
export const pay_period_duration = (a) => {
  ...
  // eslint-disable-next-line no-undef
  pay_period_duration$(); // never run, but here to "trick" calculang graph logic
};
...
export const op_gross_salary = (a) => {
  ...
  // eslint-disable-next-line no-undef
  op_gross_salary$(); // never run, but here to "trick" calculang graph logic
};
...
export const pay_period_gross_salary = (a) => {
  ...
  // eslint-disable-next-line no-undef
  pay_period_gross_salary$(); // never run, but here to "trick" calculang graph logic
};
...
export const fut_gross_salary = (a) => {
  ...
  // eslint-disable-next-line no-undef
  fut_gross_salary$(); // never run, but here to "trick" calculang graph logic
};
...
export const usc_payable = (a) => {
  ...
  // eslint-disable-next-line no-undef
  usc_payable$(); // never run, but here to "trick" calculang graph logic
};
...
export const op_pension_contribution = (a) => {
  ...
  // eslint-disable-next-line no-undef
  op_pension_contribution$(); // never run, but here to "trick" calculang graph logic
};
...
export const pay_period_pension_contribution = (a) => {
  ...
  // eslint-disable-next-line no-undef
  pay_period_pension_contribution$(); // never run, but here to "trick" calculang graph logic
};
...
export const fut_pension_contribution = (a) => {
  ...
  // eslint-disable-next-line no-undef
  fut_pension_contribution$(); // never run, but here to "trick" calculang graph logic
};
...
export const paye_taxable_by_band_id = (a) => {
  ...
  // eslint-disable-next-line no-undef
  paye_taxable_by_band_id$(); // never run, but here to "trick" calculang graph logic
};
...
export const paye_exempt = (a) => {
  ...
  // eslint-disable-next-line no-undef
  paye_exempt$(); // never run, but here to "trick" calculang graph logic
};
...
export const tax_credits_pa = (a) => {
  ...
  // eslint-disable-next-line no-undef
  tax_credits_pa$(); // never run, but here to "trick" calculang graph logic
};
...
export const tax_credits_deducted = (a) => {
  ...
  // eslint-disable-next-line no-undef
  tax_credits_deducted$(); // never run, but here to "trick" calculang graph logic
};
...
export const paye_payable = (a) => {
  ...
  // eslint-disable-next-line no-undef
  paye_payable$(); // never run, but here to "trick" calculang graph logic
};
...
export const factor_for_credits_and_bands = (a) => {
  ...
  // eslint-disable-next-line no-undef
  factor_for_credits_and_bands$(); // never run, but here to "trick" calculang graph logic
};
...
export const prsi_payable = (a) => {
  ...
  // eslint-disable-next-line no-undef
  prsi_payable$(); // never run, but here to "trick" calculang graph logic
};
...
export const net_salary_pay_period = (a) => {
  ...
  // eslint-disable-next-line no-undef
  net_salary_pay_period$(); // never run, but here to "trick" calculang graph logic
};
