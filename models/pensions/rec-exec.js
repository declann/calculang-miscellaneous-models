...
const emper_contribution_rate_actual_co = ({ rec_step_in, age_opening_in, age_closing_in }) => {
...
const contribution_charge_actual_co = ({ rec_step_in, age_opening_in, age_closing_in }) => {
...
const unit_balance = ({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) => {
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) <= Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age_0"])({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) - 1) return Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["fund_value_0"])({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) / unit_price({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in });else
  return unit_balance({ rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in, age_in: Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) - 1 }) + unit_allocation({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in });
...
1 - Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["contribution_charge"])({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in })) /
...
const unit_price = ({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) => {
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) <= Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age_0"])({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in })) return 1;else
  return unit_price({ rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in, age_in: Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) - 1 }) * (1 + Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["unit_growth_rate"])({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }));
};
...
const accumulated_empee_contributions = ({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) => {
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) == Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age_0"])({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) - 1) return 0;else

  return (
    accumulated_empee_contributions({ rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in, age_in: Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) - 1 }) +
...
Object(_simple_incometax_cul_cul_scope_id_2_cul_parent_scope_id_1__WEBPACK_IMPORTED_MODULE_1__[/* income_tax */ "a"])({ age_in,
  gross_salary_in: salary({ rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in, age_in: Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) - 1 }),
  tax_credits_in: 3000,
...
const emper_contribution = ({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) => {
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) <= Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age_0"])({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) - 1 || Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) == Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["retirement_age"])({ age_in, rec_step_in, age_opening_in, age_closing_in, actuals_in })) return 0;else
  return salary({ rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in, age_in: Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) - 1 }) * Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["emper_contribution_rate"])({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in });
};
...
const salary = ({ age_in, rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in }) => {
  ...
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["age"])({ age_in }) >= Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["retirement_age"])({ age_in, rec_step_in, age_opening_in, age_closing_in, actuals_in })) return 0;else
...
// at retirement:
fund_value({ rec_step_in, age_opening_in, age_closing_in, rec_step_inputs_in, inputs_in, actuals_in, age_in: Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_0__["retirement_age"])({ age_in, rec_step_in, age_opening_in, age_closing_in, actuals_in }) });
...
/* harmony import */ var _projected_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
...
const percentage_limit = ({ age_in }) => {
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_1__["age"])({ age_in }) < 30) return 0.15;else
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_1__["age"])({ age_in }) < 40) return 0.2;else
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_1__["age"])({ age_in }) < 50) return 0.25;else
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_1__["age"])({ age_in }) < 55) return 0.3;else
  if (Object(_rec_exec_cul_js__WEBPACK_IMPORTED_MODULE_1__["age"])({ age_in }) < 60) return 0.35;else
  return 0.4;
};
