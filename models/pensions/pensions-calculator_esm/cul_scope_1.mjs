...
export const fund_value_ = ({ age_in, age_0_in, fund_value_0_in, unit_growth_rate_in, retirement_age_in, salary_inflation_rate_in, empee_contribution_rate_in }) => unit_balance({ age_in, age_0_in, fund_value_0_in, unit_growth_rate_in, retirement_age_in, salary_inflation_rate_in, empee_contribution_rate_in }) * unit_price({ age_in, age_0_in, unit_growth_rate_in }); // not allowing for multiple funds now

export const unit_balance_ = ({ age_in, age_0_in, fund_value_0_in, unit_growth_rate_in, retirement_age_in, salary_inflation_rate_in, empee_contribution_rate_in }) => {
...
export const unit_allocation_ = ({ age_in, age_0_in, retirement_age_in, salary_inflation_rate_in, empee_contribution_rate_in, unit_growth_rate_in }) => empee_contribution({ age_in, age_0_in, retirement_age_in, salary_inflation_rate_in, empee_contribution_rate_in }) / unit_price({ age_in, age_0_in, unit_growth_rate_in }); // todo emper contribution, AVCs?
...
export const empee_contribution_ = ({ age_in, age_0_in, retirement_age_in, salary_inflation_rate_in, empee_contribution_rate_in }) => {
...
export const salary_ = ({ age_in, age_0_in, retirement_age_in, salary_inflation_rate_in }) => {
  // at end of year
...
export const projected_fund_value_ = ({ age_0_in, fund_value_0_in, unit_growth_rate_in, retirement_age_in, salary_inflation_rate_in, empee_contribution_rate_in }) =>
// at retirement:
...
export const salary_0_ = ({}) => annual_salary_0_in;
