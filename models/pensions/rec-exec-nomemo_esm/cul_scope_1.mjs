...
export const unit_balance = ({ age_in, rec_step_in, age_opening_in, age_closing_in }) => {
  if (age({ age_in }) <= age_0({ age_in, rec_step_in, age_opening_in, age_closing_in }) - 1) return fund_value_0({ age_in, rec_step_in, age_opening_in, age_closing_in }) / unit_price({ age_in, rec_step_in, age_opening_in, age_closing_in });else
...
export const unit_price = ({ age_in, rec_step_in, age_opening_in, age_closing_in }) => {
  if (age({ age_in }) <= age_0({ age_in, rec_step_in, age_opening_in, age_closing_in })) return 1;else
...
export const empee_contribution = ({ age_in, rec_step_in, age_opening_in, age_closing_in }) => {
  if (age({ age_in }) <= age_0({ age_in, rec_step_in, age_opening_in, age_closing_in }) - 1 || age({ age_in }) == retirement_age({ age_in, rec_step_in, age_opening_in, age_closing_in })) return 0;else
...
// at retirement:
fund_value({ rec_step_in, age_opening_in, age_closing_in, age_in: retirement_age({ age_in, rec_step_in, age_opening_in, age_closing_in }) });
