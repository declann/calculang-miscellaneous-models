...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "v0$m", function() { return v0$m; });
...
/* harmony import */ var _triple_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(31);
...
const v0$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_triple_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* v0_ */ "b"], JSON.stringify);
const v0 = (a) => {
  return v0$m(a);
  // eslint-disable-next-line no-undef
  Object(_triple_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* v0_ */ "b"])({ v0_in }); // never run, but here to "trick" calculang graph logic
};
...
const t$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_triple_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* t_ */ "a"], JSON.stringify);
const t = (a) => {
  return t$m(a);
  // eslint-disable-next-line no-undef
  Object(_triple_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* t_ */ "a"])({ t_in }); // never run, but here to "trick" calculang graph logic
};
...
const v$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_triple_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* v_ */ "c"], JSON.stringify);
const v = (a) => {
  return v$m(a);
  // eslint-disable-next-line no-undef
  Object(_triple_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* v_ */ "c"])({ t_in, v0_in }); // never run, but here to "trick" calculang graph logic
};
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return v0_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return t_; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return v_; });
/* harmony import */ var _triple_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(25);

const v0_ = ({ v0_in }) => v0_in; // value at start
const t_ = ({ t_in }) => t_in;

const v_ = ({ t_in, v0_in }) => {
  if (Object(_triple_cul_js__WEBPACK_IMPORTED_MODULE_0__["t"])({ t_in }) == 0) return Object(_triple_cul_js__WEBPACK_IMPORTED_MODULE_0__["v0"])({ v0_in });else
  return Object(_triple_cul_js__WEBPACK_IMPORTED_MODULE_0__["v"])({ v0_in, t_in: Object(_triple_cul_js__WEBPACK_IMPORTED_MODULE_0__["t"])({ t_in }) - 1 }) * 3;
};
