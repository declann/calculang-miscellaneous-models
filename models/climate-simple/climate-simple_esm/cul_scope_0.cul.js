...
export const emissions_rate = (a) => {
  ...
  emissions_rate$(); // never run, but here to "trick" calculang graph logic
};
...
export const climate_change_sensitivity = (a) => {
  ...
  // eslint-disable-next-line no-undef
  climate_change_sensitivity$(); // never run, but here to "trick" calculang graph logic
};
...
export const absorption = (a) => {
  ...
  // eslint-disable-next-line no-undef
  absorption$(); // never run, but here to "trick" calculang graph logic
};
...
export const drawdown = (a) => {
  return drawdown$m(a);
  // eslint-disable-next-line no-undef
  drawdown$(); // never run, but here to "trick" calculang graph logic
};
...
export const CO2_concentration = (a) => {
  ...
  // eslint-disable-next-line no-undef
  CO2_concentration$(); // never run, but here to "trick" calculang graph logic
};
...
export const net_carbon = (a) => {
  ...
  // eslint-disable-next-line no-undef
  net_carbon$(); // never run, but here to "trick" calculang graph logic
};
...
export const CO2_concentration_delta = (a) => {
  ...
  // eslint-disable-next-line no-undef
  CO2_concentration_delta$(); // never run, but here to "trick" calculang graph logic
};
...
export const temperature = (a) => {
  ...
  // eslint-disable-next-line no-undef
  temperature$(); // never run, but here to "trick" calculang graph logic
};
...
export const concentration_factor = (a) => {
  ...
  // eslint-disable-next-line no-undef
  concentration_factor$(); // never run, but here to "trick" calculang graph logic
};
...
export const temperature_delta = (a) => {
  ...
  // eslint-disable-next-line no-undef
  temperature_delta$(); // never run, but here to "trick" calculang graph logic
};
