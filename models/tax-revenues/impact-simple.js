...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return gross_salary_A; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return pension_contribution_A; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return pension_contribution; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return tax_credits; });
...
const gross_salary = ({ gross_salary_A_in }) => gross_salary_A({ gross_salary_A_in });
const pension_contribution = ({ pension_contribution_A_in }) => pension_contribution_A({ pension_contribution_A_in });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "b", function() { return _simple_incometax_cul_cul_scope_id_4_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__["a"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "d", function() { return _simple_incometax_cul_cul_scope_id_4_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__["c"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "c", function() { return _simple_incometax_cul_cul_scope_id_4_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__["b"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "e", function() { return _simple_incometax_cul_cul_scope_id_4_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__["d"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "gross_salary_A", function() { return _A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__["b"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "pension_contribution_A", function() { return _A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__["g"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "net_salary_A", function() { return _A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__["c"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "paye_taxable_salary_A", function() { return _A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__["e"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "net_salary_plus_pension_contribution_A", function() { return _A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__["d"]; });
...
Object(_B_cul_cul_scope_id_2_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* pension_contribution_B */ "e"])({ pension_contribution_in }) - Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* pension_contribution_A */ "g"])({ pension_contribution_A_in });

const paye_taxable_salary_impact = ({ gross_salary_in, pension_contribution_in, gross_salary_A_in, pension_contribution_A_in }) =>
Object(_B_cul_cul_scope_id_2_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* paye_taxable_salary_B */ "d"])({ gross_salary_in, pension_contribution_in }) - Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* paye_taxable_salary_A */ "e"])({ gross_salary_A_in, pension_contribution_A_in });

const net_salary_impact = ({ gross_salary_in, pension_contribution_in, tax_credits_in, gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) => Object(_B_cul_cul_scope_id_2_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* net_salary_B */ "b"])({ gross_salary_in, pension_contribution_in, tax_credits_in }) - Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* net_salary_A */ "c"])({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in });
const gross_salary_impact = ({ gross_salary_A_in }) => Object(_B_cul_cul_scope_id_2_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__["gross_salary_B"])({}) - Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary_A */ "b"])({ gross_salary_A_in });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return pension_contribution; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return paye_taxable_salary; });
...
// functions:
const net_salary = ({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) => Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary */ "a"])({ gross_salary_A_in }) - income_tax({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in });

const income_tax = ({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) => paye({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) + prsi({ gross_salary_A_in }) + usc({ gross_salary_A_in });

const effective_rate = ({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) => 1 - net_salary({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) / Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary */ "a"])({ gross_salary_A_in });

const prsi_taxable_salary = ({ gross_salary_A_in }) => Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary */ "a"])({ gross_salary_A_in });

const prsi = ({ gross_salary_A_in }) =>
prsi_taxable_salary({ gross_salary_A_in }) * prsi_rate({}) * (Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary */ "a"])({ gross_salary_A_in }) > 352 * 52 ? 1 : 0); // todo feature flag RE threshold
...
const usc_taxable_salary = ({ gross_salary_A_in }) => Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary */ "a"])({ gross_salary_A_in }); // pay usc on pension contribution

const usc_by_band_id = ({ usc_band_id_in, gross_salary_A_in }) =>
usc_rate({ usc_band_id_in }) *
Math.min(
usc_band_end({ usc_band_id_in }) - usc_band_start({ usc_band_id_in }),
...
const usc = ({ gross_salary_A_in }) =>
usc_table({}).reduce(
(a, v) => a + usc_by_band_id({ gross_salary_A_in, usc_band_id_in: v.band_id }),
0) * (
Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary */ "a"])({ gross_salary_A_in }) > 13000 ? 1 : 0);
...
const paye_taxable_salary = ({ gross_salary_A_in, pension_contribution_A_in }) =>
Math.max(0, Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary */ "a"])({ gross_salary_A_in }) - Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* pension_contribution */ "f"])({ pension_contribution_A_in }));

const paye_by_band_id = ({ paye_band_id_in, gross_salary_A_in, pension_contribution_A_in }) =>
paye_rate({ paye_band_id_in }) *
Math.min(
paye_band_end({ paye_band_id_in }) - paye_band_start({ paye_band_id_in }),
...
const paye_over_bands = ({ gross_salary_A_in, pension_contribution_A_in }) =>
Math.max(
0,
paye_table({}).reduce(
...
const paye = ({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) => Math.max(paye_over_bands({ gross_salary_A_in, pension_contribution_A_in }) - Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* tax_credits */ "h"])({ tax_credits_A_in }), 0);

const net_salary_plus_pension_contribution = ({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) =>
net_salary({ gross_salary_A_in, pension_contribution_A_in, tax_credits_A_in }) + Object(_A_cul_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_0__[/* pension_contribution */ "f"])({ pension_contribution_A_in });
