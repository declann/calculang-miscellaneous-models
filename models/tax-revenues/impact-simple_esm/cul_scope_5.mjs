import { tax_credits } from "./cul_scope_1.mjs";import { gross_salary } from "./cul_scope_1.mjs";import { tax_credits_A } from "./cul_scope_1.mjs";import { pension_contribution_A } from "./cul_scope_1.mjs";import { gross_salary_A } from "./cul_scope_1.mjs";import { gross_salary_impact } from "./cul_scope_0.mjs";import { net_salary_impact } from "./cul_scope_0.mjs";import { paye_taxable_salary_impact } from "./cul_scope_0.mjs";import { pension_contribution_impact } from "./cul_scope_0.mjs";import { pension_contribution } from "./cul_scope_3.mjs";import { paye_taxable_salary } from "./cul_scope_3.mjs";import { pension_contribution_B } from "./cul_scope_2.mjs";import { net_salary_plus_pension_contribution_B } from "./cul_scope_2.mjs";import { paye_taxable_salary_B } from "./cul_scope_2.mjs";import { net_salary_B } from "./cul_scope_2.mjs"; // heavily simplified incometax calculation for Irish incometax
...
// functions:
export const net_salary = ({ gross_salary_A_in, gross_salary_in, pension_contribution_in, tax_credits_A_in }) => gross_salary({ gross_salary_A_in }) - income_tax({ gross_salary_in, pension_contribution_in, tax_credits_A_in, gross_salary_A_in });

export const income_tax = ({ gross_salary_in, pension_contribution_in, tax_credits_A_in, gross_salary_A_in }) => paye({ gross_salary_in, pension_contribution_in, tax_credits_A_in }) + prsi({ gross_salary_A_in }) + usc({ gross_salary_A_in });

export const effective_rate = ({ gross_salary_A_in, gross_salary_in, pension_contribution_in, tax_credits_A_in }) => 1 - net_salary({ gross_salary_A_in, gross_salary_in, pension_contribution_in, tax_credits_A_in }) / gross_salary({ gross_salary_A_in });
...
export const paye_taxable_salary_ = ({ gross_salary_A_in, pension_contribution_in }) =>
Math.max(0, gross_salary({ gross_salary_A_in }) - pension_contribution({ pension_contribution_in }));
...
export const net_salary_plus_pension_contribution = ({ gross_salary_A_in, gross_salary_in, pension_contribution_in, tax_credits_A_in }) =>
net_salary({ gross_salary_A_in, gross_salary_in, pension_contribution_in, tax_credits_A_in }) + pension_contribution({ pension_contribution_in });