...
// tax rate an input
export const tax_rate_ = ({ tax_rate_in }) => tax_rate_in;

export const tax_credit_proposed_ = ({ tax_credit_proposed_in }) => tax_credit_proposed_in;
...
export const band_ = ({ band_in }) => band_in;

export const usc_table_ = ({ usc_table_in }) => usc_table_in;

export const paye_table_ = ({ paye_table_in }) => paye_table_in;

export const prsi_rate_ = ({ prsi_rate_in }) => prsi_rate_in;