...
export const income_tax_by_taxpayer_ = (a) => {
  ...
  // eslint-disable-next-line no-undef
  income_tax_by_taxpayer$({ tax_credit_proposed_in, prsi_rate_in, taxpayer_table_in, taxpayer_id_in, usc_table_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const paye_by_taxpayer_ = (a) => {
  ...
  // eslint-disable-next-line no-undef
  paye_by_taxpayer$({ tax_credit_proposed_in, taxpayer_table_in, taxpayer_id_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const prsi_by_taxpayer_ = (a) => {
  ...
  // eslint-disable-next-line no-undef
  prsi_by_taxpayer$({ prsi_rate_in, taxpayer_table_in, taxpayer_id_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const income_tax_sum_ = (a) => {
  ...
  // eslint-disable-next-line no-undef
  income_tax_sum$({ taxpayer_table_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const paye_sum_ = (a) => {
  return paye_sum$m(a);
  // eslint-disable-next-line no-undef
  paye_sum$({ taxpayer_table_in, tax_credit_proposed_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
