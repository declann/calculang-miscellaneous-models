...
export const income_tax_by_taxpayer_ = ({ tax_credit_proposed_in, prsi_rate_in, taxpayer_table_in, taxpayer_id_in, usc_table_in, taxpayer_count_in }) =>
income_tax({ tax_credit_proposed_in, prsi_rate_in, taxpayer_table_in, taxpayer_id_in, usc_table_in }) * proportion({ taxpayer_table_in, taxpayer_id_in }) * taxpayer_count({ taxpayer_count_in });
export const paye_by_taxpayer_ = ({ tax_credit_proposed_in, taxpayer_table_in, taxpayer_id_in, taxpayer_count_in }) => paye({ tax_credit_proposed_in }) * proportion({ taxpayer_table_in, taxpayer_id_in }) * taxpayer_count({ taxpayer_count_in });
export const usc_by_taxpayer_ = ({ usc_table_in, taxpayer_table_in, taxpayer_id_in, taxpayer_count_in }) => usc({ usc_table_in }) * proportion({ taxpayer_table_in, taxpayer_id_in }) * taxpayer_count({ taxpayer_count_in });
export const prsi_by_taxpayer_ = ({ prsi_rate_in, taxpayer_table_in, taxpayer_id_in, taxpayer_count_in }) => prsi({ prsi_rate_in, taxpayer_table_in, taxpayer_id_in }) * proportion({ taxpayer_table_in, taxpayer_id_in }) * taxpayer_count({ taxpayer_count_in });

export const income_tax_sum_ = ({ taxpayer_table_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in, taxpayer_count_in }) =>
taxpayer_table({ taxpayer_table_in }).reduce(
(acc, val) =>
acc +
income_tax({ tax_credit_proposed_in, prsi_rate_in, taxpayer_table_in, usc_table_in, taxpayer_id_in: val.taxpayer_id }) *
...
export const paye_sum_ = ({ taxpayer_table_in, tax_credit_proposed_in, taxpayer_count_in }) =>
taxpayer_table({ taxpayer_table_in }).reduce(
(acc, val) =>
acc +
paye({ tax_credit_proposed_in, taxpayer_id_in: val.taxpayer_id }) *
...
(acc, val) =>
acc +
prsi({ prsi_rate_in, taxpayer_table_in, taxpayer_id_in: val.taxpayer_id }) *
proportion({ taxpayer_table_in, taxpayer_id_in: val.taxpayer_id }) *
taxpayer_count({ taxpayer_count_in }),
0);
