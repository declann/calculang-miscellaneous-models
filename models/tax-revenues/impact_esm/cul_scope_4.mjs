...
export const income_tax_sum = ({ taxpayer_table_in, paye_table_in, tax_credit_proposed_in, usc_table_in, taxpayer_count_in }) =>
taxpayer_table({ taxpayer_table_in }).reduce(
(acc, val) =>
acc +
income_tax({ paye_table_in, taxpayer_table_in, tax_credit_proposed_in, usc_table_in, taxpayer_id_in: val.taxpayer_id }) *
