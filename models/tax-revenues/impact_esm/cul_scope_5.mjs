...
export const usc = ({ usc_table_in, taxpayer_table_in, taxpayer_id_in }) => usc_table({ usc_table_in }).reduce((a, v) => a + usc_by_band_id({ usc_table_in, taxpayer_table_in, taxpayer_id_in, band_id_in: v.band_id }), 0);
/*
