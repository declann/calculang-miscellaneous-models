...
export const net_salary = ({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_in, usc_table_in }) => gross_salary({ taxpayer_table_in, taxpayer_id_in }) - income_tax({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in, usc_table_in });

export const gross_salary_ = ({ gross_salary_in }) => gross_salary_in;

export const income_tax = ({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in, usc_table_in }) => Math.max(Math.max(paye({ paye_table_in, taxpayer_table_in, taxpayer_id_in }) - tax_credit({ tax_credit_in }), 0) + prsi({ taxpayer_table_in, taxpayer_id_in }) + usc({ usc_table_in, taxpayer_table_in, taxpayer_id_in }), 0);

export const tax_credit = ({ tax_credit_in }) => tax_credit_in;

export const effective_rate = ({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_in, usc_table_in }) => 1 - net_salary({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_in, usc_table_in }) / gross_salary({ taxpayer_table_in, taxpayer_id_in });
