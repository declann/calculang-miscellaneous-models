...
export const income_tax_sum = ({ taxpayer_table_in, taxpayer_id_in }) =>
taxpayer_table({ taxpayer_table_in }).reduce(
(acc, val) => acc + income_tax({ taxpayer_table_in, taxpayer_id_in: val.taxpayer_id }) * proportion({ taxpayer_table_in, taxpayer_id_in }),
0);


export const paye_sum = ({ taxpayer_table_in, taxpayer_id_in }) =>
taxpayer_table({ taxpayer_table_in }).reduce(
(acc, val) => acc + paye({ taxpayer_table_in, taxpayer_id_in: val.taxpayer_id }) * proportion({ taxpayer_table_in, taxpayer_id_in }),
0);


export const usc_sum = ({ taxpayer_table_in, taxpayer_id_in }) =>
taxpayer_table({ taxpayer_table_in }).reduce(
(acc, val) => acc + usc({ taxpayer_table_in, taxpayer_id_in: val.taxpayer_id }) * proportion({ taxpayer_table_in, taxpayer_id_in }),
0);