...
// functions:
export const net_salary_ = ({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in }) => gross_salary({ taxpayer_table_in, taxpayer_id_in }) - pension_contribution({}) - income_tax({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in });

export const income_tax_ = ({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in }) => paye({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_proposed_in }) + prsi({ taxpayer_table_in, taxpayer_id_in, prsi_rate_in }) + usc({ usc_table_in, taxpayer_table_in, taxpayer_id_in });

export const effective_rate_ = ({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in }) => 1 - net_salary({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in }) / gross_salary({ taxpayer_table_in, taxpayer_id_in });

export const prsi_taxable_salary_ = ({ taxpayer_table_in, taxpayer_id_in }) => gross_salary({ taxpayer_table_in, taxpayer_id_in });

export const prsi_ = ({ taxpayer_table_in, taxpayer_id_in, prsi_rate_in }) =>
prsi_taxable_salary({ taxpayer_table_in, taxpayer_id_in }) * prsi_rate({ prsi_rate_in }) * (gross_salary({ taxpayer_table_in, taxpayer_id_in }) > 352 * 52 ? 1 : 0); // todo feature flag RE threshold
...
export const usc_band_end_ = ({ usc_band_id_in, usc_table_in }) => {
...
export const usc_band_start_ = ({ usc_band_id_in, usc_table_in }) => {
  if (usc_band_id({ usc_band_id_in }) == 1) return 0;
  return usc_table({ usc_table_in })[usc_band_id({ usc_band_id_in }) - 2].band_co;
};

export const usc_rate_ = ({ usc_table_in, usc_band_id_in }) => usc_table({ usc_table_in })[usc_band_id({ usc_band_id_in }) - 1].rate;
...
export const usc_by_band_id_ = ({ usc_table_in, usc_band_id_in, taxpayer_table_in, taxpayer_id_in }) =>
...
export const usc_ = ({ usc_table_in, taxpayer_table_in, taxpayer_id_in }) =>
...
export const paye_band_end_ = ({ paye_band_id_in, paye_table_in }) => {
...
export const paye_band_start_ = ({ paye_band_id_in, paye_table_in }) => {
  if (paye_band_id({ paye_band_id_in }) == 1) return 0;
  return paye_table({ paye_table_in })[paye_band_id({ paye_band_id_in }) - 2].band_co;
};

export const paye_rate_ = ({ paye_table_in, paye_band_id_in }) => paye_table({ paye_table_in })[paye_band_id({ paye_band_id_in }) - 1].rate;
...
export const paye_by_band_id_ = ({ paye_table_in, paye_band_id_in, taxpayer_table_in, taxpayer_id_in }) =>
...
export const paye_over_bands_ = ({ paye_table_in, taxpayer_table_in, taxpayer_id_in }) =>
Math.max(
0,
...
export const paye_ = ({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_proposed_in }) => Math.max(paye_over_bands({ paye_table_in, taxpayer_table_in, taxpayer_id_in }) - tax_credits({ tax_credit_proposed_in }), 0);

export const net_salary_plus_pension_contribution_ = ({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in }) =>
net_salary({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_proposed_in, prsi_rate_in, usc_table_in }) + pension_contribution({});