...
export const income_tax_sum_impact = ({ taxpayer_table_in, band_in }) =>
income_tax_sum_proposed({ taxpayer_table_in, band_in }) - income_tax_sum_current({ taxpayer_table_in, band_in });

export const income_tax_impact = ({ taxpayer_table_in, taxpayer_id_in, band_in }) =>
income_tax_proposed({ taxpayer_table_in, taxpayer_id_in, band_in }) - income_tax_current({ taxpayer_table_in, taxpayer_id_in, band_in });