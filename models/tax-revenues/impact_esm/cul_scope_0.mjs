...
export const income_tax_sum_impact = ({ taxpayer_table_in, paye_table_in, usc_table_in, taxpayer_count_in }) =>
income_tax_sum_proposed({ taxpayer_table_in, paye_table_in, usc_table_in, taxpayer_count_in }) - income_tax_sum_current({ taxpayer_table_in, taxpayer_count_in });
...
export const paye_sum_impact = ({ taxpayer_table_in, paye_table_in, taxpayer_count_in }) =>
paye_sum_proposed({ taxpayer_table_in, paye_table_in, taxpayer_count_in }) - paye_sum_current({ taxpayer_table_in, taxpayer_count_in });
...
export const usc_sum_impact = ({ taxpayer_table_in, usc_table_in, taxpayer_count_in }) =>
usc_sum_proposed({ taxpayer_table_in, usc_table_in, taxpayer_count_in }) - usc_sum_current({ taxpayer_table_in, taxpayer_count_in });
