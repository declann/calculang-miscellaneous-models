...
export const income_tax_sum_proposed = (a) => {
  ...
  // eslint-disable-next-line no-undef
  income_tax_sum_proposed$({ prsi_rate_in, usc_table_in }); // never run, but here to "trick" calculang graph logic
};
...
export const income_tax_proposed = (a) => {
  ...
  // eslint-disable-next-line no-undef
  income_tax_proposed$({ prsi_rate_in, usc_table_in }); // never run, but here to "trick" calculang graph logic
};
...
export const usc_sum_proposed = (a) => {
  ...
  // eslint-disable-next-line no-undef
  usc_sum_proposed$({ usc_table_in }); // never run, but here to "trick" calculang graph logic
};
...
export const prsi_sum_proposed = (a) => {
  ...
  // eslint-disable-next-line no-undef
  prsi_sum_proposed$({ prsi_rate_in }); // never run, but here to "trick" calculang graph logic
};
...
export const prsi_proposed = (a) => {
  ...
  // eslint-disable-next-line no-undef
  prsi_proposed$({ prsi_rate_in }); // never run, but here to "trick" calculang graph logic
};
...
export const income_tax_by_taxpayer_proposed = (a) => {
  ...
  // eslint-disable-next-line no-undef
  income_tax_by_taxpayer_proposed$({ prsi_rate_in, usc_table_in }); // never run, but here to "trick" calculang graph logic
};
...
export const usc_by_taxpayer_proposed = (a) => {
  ...
  // eslint-disable-next-line no-undef
  usc_by_taxpayer_proposed$({ usc_table_in }); // never run, but here to "trick" calculang graph logic
};
...
export const prsi_by_taxpayer_proposed = (a) => {
  ...
  // eslint-disable-next-line no-undef
  prsi_by_taxpayer_proposed$({ prsi_rate_in }); // never run, but here to "trick" calculang graph logic
};
...
export const income_tax_by_taxpayer_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  income_tax_by_taxpayer_impact$({ prsi_rate_in, usc_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const paye_by_taxpayer_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  paye_by_taxpayer_impact$({ taxpayer_table_in, taxpayer_id_in, tax_credit_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const income_tax_sum_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  income_tax_sum_impact$({ prsi_rate_in, usc_table_in, taxpayer_table_in, tax_credit_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const income_tax_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  income_tax_impact$({ prsi_rate_in, usc_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in }); // never run, but here to "trick" calculang graph logic
};
...
export const paye_sum_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  paye_sum_impact$({ taxpayer_table_in, tax_credit_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const paye_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  paye_impact$({ taxpayer_table_in, taxpayer_id_in, tax_credit_in }); // never run, but here to "trick" calculang graph logic
};
...
export const usc_sum_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  usc_sum_impact$({ usc_table_in, taxpayer_table_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
...
export const prsi_sum_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  prsi_sum_impact$({ prsi_rate_in, taxpayer_table_in, taxpayer_count_in }); // never run, but here to "trick" calculang graph logic
};
