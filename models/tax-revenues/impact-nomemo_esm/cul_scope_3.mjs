import { prsi_sum } from "./cul_scope_1.mjs";import { usc_sum } from "./cul_scope_1.mjs";import { paye_sum } from "./cul_scope_1.mjs";import { income_tax_sum } from "./cul_scope_1.mjs";import { prsi_by_taxpayer } from "./cul_scope_1.mjs";import { usc_by_taxpayer } from "./cul_scope_1.mjs";import { paye_by_taxpayer } from "./cul_scope_1.mjs";import { income_tax_by_taxpayer } from "./cul_scope_1.mjs";import { proportion } from "./cul_scope_1.mjs";import { gross_salary } from "./cul_scope_1.mjs";import { taxpayer_count } from "./cul_scope_1.mjs";import { taxpayer_table } from "./cul_scope_1.mjs";import { taxpayer_id } from "./cul_scope_1.mjs";import { prsi_impact } from "./cul_scope_0.mjs";import { prsi_sum_impact } from "./cul_scope_0.mjs";import { usc_impact } from "./cul_scope_0.mjs";import { usc_sum_impact } from "./cul_scope_0.mjs";import { paye_impact } from "./cul_scope_0.mjs";import { paye_sum_impact } from "./cul_scope_0.mjs";import { income_tax_impact } from "./cul_scope_0.mjs";import { income_tax_sum_impact } from "./cul_scope_0.mjs";import { prsi_by_taxpayer_impact } from "./cul_scope_0.mjs";import { paye_by_taxpayer_impact } from "./cul_scope_0.mjs";import { usc_by_taxpayer_impact } from "./cul_scope_0.mjs";import { income_tax_by_taxpayer_impact } from "./cul_scope_0.mjs";import { paye_by_taxpayer_proposed } from "./cul_scope_2.mjs";import { prsi_by_taxpayer_proposed } from "./cul_scope_2.mjs";import { usc_by_taxpayer_proposed } from "./cul_scope_2.mjs";import { income_tax_by_taxpayer_proposed } from "./cul_scope_2.mjs";import { prsi_proposed } from "./cul_scope_2.mjs";import { prsi_sum_proposed } from "./cul_scope_2.mjs";import { usc_proposed } from "./cul_scope_2.mjs";import { usc_sum_proposed } from "./cul_scope_2.mjs";import { paye_proposed } from "./cul_scope_2.mjs";import { paye_sum_proposed } from "./cul_scope_2.mjs";import { effective_rate_proposed } from "./cul_scope_2.mjs";import { income_tax_proposed } from "./cul_scope_2.mjs";import { income_tax_sum_proposed } from "./cul_scope_2.mjs"; // heavily simplified incometax calculation for Irish incometax
...
// functions:
export const net_salary = ({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in, tax_credits_in }) => gross_salary({ taxpayer_table_in, taxpayer_id_in }) - pension_contribution({ pension_contribution_in }) - income_tax({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in, tax_credits_in });

export const income_tax = ({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in, tax_credits_in }) => paye({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in, tax_credits_in }) + prsi({ taxpayer_table_in, taxpayer_id_in }) + usc({ taxpayer_table_in, taxpayer_id_in });

export const effective_rate = ({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in, tax_credits_in }) => 1 - net_salary({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in, tax_credits_in }) / gross_salary({ taxpayer_table_in, taxpayer_id_in });
...
export const paye_by_band_id = ({ paye_band_id_in, taxpayer_table_in, taxpayer_id_in, pension_contribution_in }) =>
...
export const paye_over_bands = ({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in }) =>
Math.max(
0,
paye_table({}).reduce(
...
export const paye = ({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in, tax_credits_in }) => Math.max(paye_over_bands({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in }) - tax_credits({ tax_credits_in }), 0);

export const net_salary_plus_pension_contribution = ({ taxpayer_table_in, taxpayer_id_in, pension_contribution_in, tax_credits_in }) =>
