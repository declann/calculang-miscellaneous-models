...
export const income_tax_by_taxpayer = ({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in, prsi_rate_in, usc_table_in, taxpayer_count_in }) =>
income_tax({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in, prsi_rate_in, usc_table_in }) * proportion({ taxpayer_table_in, taxpayer_id_in }) * taxpayer_count({ taxpayer_count_in });
export const paye_by_taxpayer = ({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in, taxpayer_count_in }) => paye({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in }) * proportion({ taxpayer_table_in, taxpayer_id_in }) * taxpayer_count({ taxpayer_count_in });
...
export const income_tax_sum = ({ taxpayer_table_in, paye_table_in, tax_credit_in, prsi_rate_in, usc_table_in, taxpayer_count_in }) =>
taxpayer_table({ taxpayer_table_in }).reduce(
(acc, val) =>
acc +
income_tax({ paye_table_in, taxpayer_table_in, tax_credit_in, prsi_rate_in, usc_table_in, taxpayer_id_in: val.taxpayer_id }) *
...
export const paye_sum = ({ taxpayer_table_in, paye_table_in, tax_credit_in, taxpayer_count_in }) =>
taxpayer_table({ taxpayer_table_in }).reduce(
(acc, val) =>
acc +
paye({ paye_table_in, taxpayer_table_in, tax_credit_in, taxpayer_id_in: val.taxpayer_id }) *
