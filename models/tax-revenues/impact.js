...
/* harmony import */ var _impact_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
/* harmony import */ var _impact_cul_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
...
/* harmony import */ var _proposed_cul_cul_scope_id_2_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _impact_cul_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
...
Math.max(0, Object(_incometax_set_cul_cul_scope_id_3_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_0__[/* gross_salary */ "b"])({ taxpayer_table_in, taxpayer_id_in }) - Object(_impact_cul_js__WEBPACK_IMPORTED_MODULE_2__["pension_contribution"])({}));
...
const paye = ({ paye_table_in, taxpayer_table_in, taxpayer_id_in, tax_credit_in }) => Math.max(paye_over_bands({ paye_table_in, taxpayer_table_in, taxpayer_id_in }) - Object(_impact_cul_js__WEBPACK_IMPORTED_MODULE_2__["tax_credits"])({ tax_credit_in }), 0);
...
net_salary({ taxpayer_table_in, taxpayer_id_in, paye_table_in, tax_credit_in, prsi_rate_in, usc_table_in }) + Object(_impact_cul_js__WEBPACK_IMPORTED_MODULE_2__["pension_contribution"])({});
...
const paye = ({ taxpayer_table_in, taxpayer_id_in, tax_credit_in }) => Math.max(paye_over_bands({ taxpayer_table_in, taxpayer_id_in }) - Object(_impact_cul_js__WEBPACK_IMPORTED_MODULE_1__["tax_credits"])({ tax_credit_in }), 0);
